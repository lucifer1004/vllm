...
class TestPullPipelineParallel:
    def test_prepares_stage_descriptors_by_layer_name(self):
        ...
        worker.kv_caches_base_addr = {
            worker.engine_id: {worker.tp_rank: [1000]}
        }
    ...
    def test_one_read_is_issued_per_remote_pp_stage(self):
        ...
        worker._packed_pp_pull_src_handles = {
            engine_id: {(0, 0): 10, (1, 0): 11}
        }
        worker._packed_pp_pull_dst_handles = {
            engine_id: {(0, 0): 20, (1, 0): 21}
        }
