...
class DFlashSpeculator(DraftModelSpeculator):
    ...
    def __init__(self, vllm_config: VllmConfig, device: torch.device):
        ...
        # Manual CUDA graphs retain raw addresses for model intermediates.
        # Keep every captured backbone output alive because the sampling nodes
        # in that graph read from its storage during replay.
